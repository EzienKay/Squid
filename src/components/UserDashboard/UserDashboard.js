  ...
  return (
    <div className="dash">
      <Container>
        <Row>
          <Col xs={3}>
            <div className="smaller-div rounded">
              <h4>{leftCardLabel}</h4>
            </div>
          </Col>
          <Col xs={9}>
            <div className="larger-div rounded">
              <div className="card-item account-level-card rounded shadow">
                <div>
              ...
              <div className="card-item phone-number-card rounded shadow">
                <div>
              ...
              <div className="card-item two-factor-auth-card rounded shadow">
        ...
        <Row>
          <Col>
            <div className="view-container">
              <div className="small-child rounded">
                <div>
              ...
              <div className={`bigger-child rounded ${selectedContent}`}>
                {selectedContent === 'Trade History' ? (
                  <div className='housing rounded'>
                    <p className='housing-info rounded'>You are viewing all trades for the last 4 days</p>
                    <p className='housing-info rounded'>Filters</p>
                    <p className='housing-info rounded'>Completed Trades: 0% (trades out of 0)</p>
                  </div>
                  ...
                  <div>
                    <div>
                      <h4>Balance</h4>
                      <div className='housing-info rounded'>
                        <h5>0 BTC</h5>
